...
function oSkin:QuestLog()
	...
	self:Hook("QuestLog_UpdateQuestDetails", function(doNotScroll)
		...
		for i = 1, 10 do
    		...
    		_G["QuestLogObjective"..i]:SetTextColor(1,1,1)
    	end
    	local r, g, b, a = _G["QuestLogRequiredMoneyText"]:GetTextColor()
    	_G["QuestLogRequiredMoneyText"]:SetTextColor(1,1,1)
    	_G["QuestLogRewardTitleText"]:SetTextColor(1,1,1)
...
--	QuestLogHighlightFrame
	...
	_G["QuestLogQuestTitle"]:SetTextColor(1,1,1)
...
--	QuestLogRequiredMoneyText
	...
	_G["QuestLogDescriptionTitle"]:SetTextColor(1,1,1)
