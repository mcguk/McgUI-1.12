...
function oSkin:EQL3Frame()
	...
	self:Hook("QuestLog_UpdateQuestDetails", function(doNotScroll)
		...
		for i = 1, 10 do
		    ...
		    _G["EQL3_QuestLogObjective"..i]:SetTextColor(1,1,1)
		end
		local r, g, b, a = _G["EQL3_QuestLogRequiredMoneyText"]:GetTextColor()
		_G["EQL3_QuestLogRequiredMoneyText"]:SetTextColor(1,1,1)
		_G["EQL3_QuestLogRewardTitleText"]:SetTextColor(1,1,1)
		_G["EQL3_QuestLogItemChooseText"]:SetTextColor(1,1,1)
		_G["EQL3_QuestLogItemReceiveText"]:SetTextColor(1,1,1)
		end)
	...
	_G["EQL3_QuestLogQuestTitle"]:SetTextColor(1,1,1)
	_G["EQL3_QuestLogObjectivesText"]:SetTextColor(1,1,1)
	_G["EQL3_QuestLogDescriptionTitle"]:SetTextColor(1,1,1)
	_G["EQL3_QuestLogQuestDescription"]:SetTextColor(1,1,1)
