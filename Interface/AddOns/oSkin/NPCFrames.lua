...
function oSkin:GossipFrame()
	...
	for i = 1, NUMGOSSIPBUTTONS do
		_G["GossipTitleButton"..i]:SetTextColor(1,1,1)
	end 
...
function oSkin:QuestFrameRewardPanel_OnShow()
	...
	_G["QuestRewardTitleText"]:SetTextColor(1,1,1)
	_G["QuestRewardText"]:SetTextColor(1,1,1)
	_G["QuestRewardRewardTitleText"]:SetTextColor(1,1,1)
	_G["QuestRewardItemChooseText"]:SetTextColor(1,1,1)
	_G["QuestRewardItemReceiveText"]:SetTextColor(1,1,1)
	_G["QuestRewardSpellLearnText"]:SetTextColor(1,1,1)

	for i = 1, MAX_NUM_ITEMS do
		_G["QuestRewardItem"..i]:SetTextColor(1,1,1)
	end 
...
function oSkin:QuestFrameProgressPanel_OnShow()
	...
	for i = 1, MAX_REQUIRED_ITEMS do
		_G["QuestProgressItem"..i]:SetTextColor(1,1,1)
	end 
...
function oSkin:QuestFrameGreetingPanel_OnShow()
	...
	for i = 1, MAX_NUM_QUESTS do
		_G["QuestTitleButton"..i]:SetTextColor(1,1,1)
	end	
...
function oSkin:QuestFrameDetailPanel_OnShow()
	...
	_G["QuestTitleText"]:SetTextColor(1,1,1)
	_G["QuestDescription"]:SetTextColor(1,1,1)
	_G["QuestDetailObjectiveTitleText"]:SetTextColor(1,1,1)
	_G["QuestObjectiveText"]:SetTextColor(1,1,1)

	_G["QuestDetailRewardTitleText"]:SetTextColor(1,1,1)
	_G["QuestDetailItemChooseText"]:SetTextColor(1,1,1)
	_G["QuestDetailItemReceiveText"]:SetTextColor(1,1,1)
	_G["QuestDetailSpellLearnText"]:SetTextColor(1,1,1)

	for i = 1, MAX_NUM_ITEMS do
		_G["QuestDetailItem"..i]:SetTextColor(1,1,1)
	end 
