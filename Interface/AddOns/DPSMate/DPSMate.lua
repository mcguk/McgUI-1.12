...
local _G = getglobal
local classcolor = {
	rogue = {r=0.15, g=0.15, b=0.15},
	priest = {r=0.15,g=0.15,b=0.15},
	druid = {r=0.15,g=0.15,b=0.15},
	warrior = {r=0.15,g=0.15,b=0.15},
	warlock = {r=0.15,g=0.15,b=0.15},
	mage = {r=0.15,g=0.15,b=0.15},
	hunter = {r=0.15,g=0.15,b=0.15},
	paladin = {r=0.15,g=0.15,b=0.15},
	shaman = {r=0.15,g=0.15,b=0.15},
}
local t = {}
