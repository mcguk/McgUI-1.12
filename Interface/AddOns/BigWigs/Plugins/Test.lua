...
function BigWigsTest:BigWigs_RecvSync(sync, rest, nick)
	if sync == "TestSync" then
		...
		self:Bar(L["Testing Sync"], 10, "Spell_Frost_FrostShock", true,303030)
...
function BigWigsTest:BigWigs_Test()
	...
	self:Bar(L["Test Bar 4"], 3, "Spell_Nature_ResistNature", true, 303030)
	self:Bar(L["Test Bar 3"], 5, "Spell_Nature_ResistNature", true, 303030)
